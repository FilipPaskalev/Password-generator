...
2. Select ```Code``` from top navigation section ![](./assets/imgs/gitHub-section-select-code.png)

3. Select ```<> Code``` dropdown button from sub section ![](./assets/imgs/gitHub-section-select-code-dropdown.png)

4. Select ```Download ZIP``` from dropdown menu to download project in .zip format ![](./assets/imgs/gitHub-dropdown-download-zip-selection.png)

5. Unzip the project. (You can use [7-zip](https://www.7-zip.org/) if you don't have software for unzipping. It's free.)
...
2. Above the list of files, click  Code. ![](./assets/imgs/gitHub-section-select-code-dropdown.png)
